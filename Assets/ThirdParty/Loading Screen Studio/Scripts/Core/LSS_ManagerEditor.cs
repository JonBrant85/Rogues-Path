...
namespace Michsky.LSS
{
    ...
    {
        private LoadingScreenManager lssmTarget;
        ...
        {
            lssmTarget = (LoadingScreenManager)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (lsList.Count == 1 || lsList.Count >= 1)
            {
                ...
                if (lssmTarget.loadingMode == LoadingScreenManager.LoadingMode.Additive && Application.isPlaying)
                {
                    GUI.enabled = false;
